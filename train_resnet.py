...
def main(subset_size=.1, greedy=0):
    ...
    # os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu  # Disabled for CPU-only execution
    ...
    model = resnet.__dict__[args.arch]()  # Removed DataParallel for CPU
    model.to(device)
    ...
    # Use the module-level IndexedDataset class instead of local class
