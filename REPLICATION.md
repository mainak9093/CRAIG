...
- All datasets live inside this repo under `data/` (gitignored, regenerated by
  `download_data.py`); all outputs under `results/` (gitignored).
...
# 2. datasets (once)  -> ./data, verifies the exact paper counts
